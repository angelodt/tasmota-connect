 ...
 */
metadata {
    definition(name: "Tasmota Virtual Fan Light", namespace: "hongtat", author: "Angelo Daiher", ocfDeviceType: "oic.d.light", vid: "generic-switch") {
        capability "Switch"
        capability "Actuator"
